...
// Esse evento pega o que está escrito no título/funcionalidade/churn e copia para descrição
...
cancelar.addEventListener("click", fecharTicket);
...
////////////////////////////////////////////////////////////////////////////////
// FUNÇÕES INÍCIO ---->
function canceladoOculto() {
    if (divFechar.style.display === "block") {
        cancelarDiv.style.display = "none";
    }
}

function canceladoVisivel(){
    cancelarDiv.style.display = "block";
}
