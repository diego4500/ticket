...
formulario.addEventListener("submit", async (e) => {
    ...
    const dados = {
        ...
        card: document.getElementById("card")?.checked || false,
        status: document.getElementById("status")?.value || "",
        titulo: document.getElementById("titulo")?.value || "",
        menu_duvida: document.getElementById("menu_duvida")?.value || "",
        descricao: document.getElementById("descricao")?.value || "",
        churn: document.getElementById("churn_cadastrada")?.value || "",
        funcionalidade: document.getElementById("funcionalidade_cadastrada")?.value || "",
        sistema: document.getElementById("sistemas_cadastrada")?.value || "",
        data: dataFormatada,
        hora: horaFormatada,
    ...
    try {
        ...
        if (response.ok) {
            ...
            sugerirProximoTicket(); // só avança se salvar com sucesso
        } else {
